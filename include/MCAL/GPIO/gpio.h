...
// don't use this shit as pin num
// GPIO Pin definitions
#define    GPIO_PIN_0_mask      (0x0001)
#define    GPIO_PIN_1_mask      (0x0002)
#define    GPIO_PIN_2_mask      (0x0004)
#define    GPIO_PIN_3_mask      (0x0008)
#define    GPIO_PIN_4_mask      (0x0010)
#define    GPIO_PIN_5_mask      (0x0020)
#define    GPIO_PIN_6_mask      (0x0040)
#define    GPIO_PIN_7_mask      (0x0080)
#define    GPIO_PIN_8_mask      (0x0100)
#define    GPIO_PIN_9_mask      (0x0200)
#define    GPIO_PIN_10_mask     (0x0400)
#define    GPIO_PIN_11_mask     (0x0800)
#define    GPIO_PIN_12_mask     (0x1000)
#define    GPIO_PIN_13_mask     (0x2000)
#define    GPIO_PIN_14_mask     (0x4000)
#define    GPIO_PIN_15_mask     (0x8000)
