...
typedef enum{
  // AHB1
    ...
    // APB1
    RCC_TIMER_2 = RCC_BUS_ENCODE(BUS_APB1, 0),
    RCC_TIMER_3 = RCC_BUS_ENCODE(BUS_APB1, 1),
    RCC_TIMER_4 = RCC_BUS_ENCODE(BUS_APB1, 2),
    RCC_TIMER_5 = RCC_BUS_ENCODE(BUS_APB1, 3),
    RCC_WWDG    = RCC_BUS_ENCODE(BUS_APB1, 11),
    RCC_SPI2    = RCC_BUS_ENCODE(BUS_APB1, 14),
    RCC_SPI3    = RCC_BUS_ENCODE(BUS_APB1, 15),
    RCC_USART2  = RCC_BUS_ENCODE(BUS_APB1, 17),
    RCC_I2C1    = RCC_BUS_ENCODE(BUS_APB1, 21),
    RCC_I2C2    = RCC_BUS_ENCODE(BUS_APB1, 22),
    RCC_I2C3    = RCC_BUS_ENCODE(BUS_APB1, 23),
    RCC_PWR     = RCC_BUS_ENCODE(BUS_APB1, 28),
    // APB2
    RCC_TIMER_1 = RCC_BUS_ENCODE(BUS_APB2, 0),
    RCC_USART1  = RCC_BUS_ENCODE(BUS_APB2, 4),
    RCC_USART6  = RCC_BUS_ENCODE(BUS_APB2, 5),
    RCC_ADC1    = RCC_BUS_ENCODE(BUS_APB2, 8),
    RCC_SDIO    = RCC_BUS_ENCODE(BUS_APB2, 11),
    RCC_SPI1    = RCC_BUS_ENCODE(BUS_APB2, 12),
    RCC_SPI4    = RCC_BUS_ENCODE(BUS_APB2, 13),
    RCC_SYSCFG  = RCC_BUS_ENCODE(BUS_APB2, 14),
    RCC_TIMER_9 = RCC_BUS_ENCODE(BUS_APB2, 16),
    RCC_TIMER_10= RCC_BUS_ENCODE(BUS_APB2, 17),
    RCC_TIMER_11= RCC_BUS_ENCODE(BUS_APB2, 18)
}rcc_Peripheral_t;
